...
{
    // MCPC+ start - we shade the libraries in our jar, so only download the deobfuscation data
    ...
    private static String[] libraries = { FMLInjectionData.debfuscationDataName() };
    private static String[] checksums = {  FMLInjectionData.deobfuscationDataHash };
    // MCPC+ end
