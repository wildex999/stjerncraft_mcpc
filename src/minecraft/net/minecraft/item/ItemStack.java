...
public final class ItemStack
{
    ...
    public void setItemDamage(int par1)
    {
        ...
        this.itemDamage = (this.itemID > 0) && (this.itemID < 256) && (this.itemID != Block.anvil.blockID) && (Item.itemsList[this.itemID] != null) ? Item.itemsList[this.itemID].getMetadata(par1) : par1; // CraftBukkit
    }
