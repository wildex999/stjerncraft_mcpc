...
public class ItemBow extends Item
{
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (var5 || par3EntityPlayer.inventory.hasItem(Item.arrow.itemID))
        {
            ...
            // CraftBukkit start
            org.bukkit.event.entity.EntityShootBowEvent cbEvent = org.bukkit.craftbukkit.event.CraftEventFactory.callEntityShootBowEvent(par3EntityPlayer, par1ItemStack, var8, var7);
            ...
            if (cbEvent.getProjectile() == var8.getBukkitEntity())
            {
