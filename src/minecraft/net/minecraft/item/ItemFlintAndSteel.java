...
public class ItemFlintAndSteel extends Item
{
    ...
    {
        int i1 = par4, clickedY = par5, clickedZ = par6; // CraftBukkit
        ...
        else
        {
            ...
            if (i1 == 0)
            {
                ...
                // CraftBukkit start
                org.bukkit.event.block.BlockPlaceEvent placeEvent = org.bukkit.craftbukkit.event.CraftEventFactory.callBlockPlaceEvent(par3World, par2EntityPlayer, blockState, i1, clickedY, clickedZ);
