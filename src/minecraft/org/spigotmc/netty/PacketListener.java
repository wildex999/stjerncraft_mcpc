...
public class PacketListener {
    ...
    static net.minecraft.network.packet.Packet callReceived(net.minecraft.network.INetworkManager networkManager, net.minecraft.network.packet.NetHandler connection, net.minecraft.network.packet.Packet packet) {
    ...
    static net.minecraft.network.packet.Packet callQueued(net.minecraft.network.INetworkManager networkManager, net.minecraft.network.packet.NetHandler connection, net.minecraft.network.packet.Packet packet) {
        for (PacketListener listener : baked) {
            try {
     ...
     */
    public net.minecraft.network.packet.Packet packetReceived(net.minecraft.network.INetworkManager networkManager, net.minecraft.network.packet.NetHandler connection, net.minecraft.network.packet.Packet packet) {
        return packet;
    }
     ...
     */
    public net.minecraft.network.packet.Packet packetQueued(net.minecraft.network.INetworkManager networkManager, net.minecraft.network.packet.NetHandler connection, net.minecraft.network.packet.Packet packet) {
        return packet;
    }
}
