...
public class CraftEventFactory {
    ...
    public static PlayerInteractEvent callPlayerInteractEvent(net.minecraft.entity.player.EntityPlayer who, Action action, int clickedX, int clickedY, int clickedZ, int clickedFace, net.minecraft.item.ItemStack itemstack) {
        ...
        Block blockClicked = craftWorld.getBlockAt(clickedX, clickedY, clickedZ); // MCPC+ - Don't bother getting the block if it's just going to be set to null later. Avoids pointles chunkloading if ChunkProviderServer.loadChunkOnProvideRequest is enabled
        BlockFace blockFace = CraftBlock.notchToBlockFace(clickedFace);
