...
* Download the required srg 
 * For 1.4.7 plugins: https://github.com/agaricusb/MinecraftRemapping/blob/master/1.4.7/vcb2obf.srg
 * For 1.4.6 plugins: https://github.com/agaricusb/MinecraftRemapping/blob/master/1.4.6/vcb2obf.srg
